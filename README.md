...
| ``Hostname_Filter=``             | Comma seperated list of hostnames that should never be updated (same wildcard-logic applies). For Example ``static.test.com,local.test.com,@.local.test.com``    (case sensitive!!!)                                        |
